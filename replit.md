...
This is a Vietnamese pharmacy management system built with React, Express, and PostgreSQL using Drizzle ORM. The application provides comprehensive functionality for managing medicine inventory, prescriptions, and patient records. It features a modern UI with Shadcn/UI components, TanStack Query for data fetching, and real-time prescription processing capabilities.
